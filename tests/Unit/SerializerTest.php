...
class SerializerTest extends GherphalizerTestBase
{
    ...
    {
        $feature = $this->serializer->parser->parse(file_get_contents(dirname(__FILE__).'/../fixtures/contact-form.feature'));
        ...
        $filename = $this->serializer->outputDir."/FeatureContactForm.php";
